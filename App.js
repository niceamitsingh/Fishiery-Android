...
const { MAIN_FRAME } = DEVICE_HEIGHT * 0.8;
...
class LoginPage extends React.Component {
  ...
  async componentDidMount() {
    ...
    Analytics.trackEvent("App Loading");
          ...
          },
          {
            ...
            onPress: () => {
              ...
              this.props.navigation.navigate("register_askLanguage", {
                ph_no: this.state.TextInputNumber
              });
            }
          }
        ],
  ...
  headerTextHi() {
    return <Text style={styles.welcome}>{this.state.hi_there}</Text>;
  }
  inputBar() {
    return (
      <TextInput
